...
import techniqueSlice, {
  initialState as techniqueState,
} from "./Slice/TechniqueSlice";
import techniqueTypeSlice, {
  initialState as techniqueTypeState,
} from "./Slice/TechniqueTypeSlice";
import skillSlice, { initialState as skillState } from "./Slice/SkillSlice";
import networkSlice, {
  initialState as networkState,
} from "./Slice/NetworkSlice";
import profileSlice, {
  initialState as profileState,
} from "./Slice/ProfileSlice";
import myProfileSlice, {
  initialState as myProfileState,
} from "./Slice/MyProfileSlice";
