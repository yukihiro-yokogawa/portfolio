...
export const initialState: Array<ProfileState> = [
  { id: 0, name: "", dateType: false, displayOrder: 0 },
];
...
const profileSlice = createSlice({
  ...
  initialState,
  reducers: {
    getProfileRequest: (_state, action: PayloadAction<Array<ProfileState>>) => [
      ...action.payload,
    ],
  },
});
...
export const getProfilesAsync = () => async (
  dispatch: (arg0: { payload: Array<ProfileState> }) => void
): Promise<void> => {
  axios
